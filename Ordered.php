...
<html>
    ...
    <body>
        <div class="part">
            ...
            <div class="main">
                <div class="header">
                    <span style="color: #5C4033"><i>Ordered Items</i></span>
                    <div class="icons">
                      <?php if($hv == 0){ ?>
                        <a href="Login.php"><i class="fa fa-sign-in" style="color: #5C4033; font-size: 0.5em;"></i></a>
                      <?php }else {?>
                    <a href="./Cart.php"><i class="fa fa-shopping-cart" style="color: #5C4033; font-size: 0.5em; margin-right: 15px;"></i></a>
                    <a href="Logout.php"><i class="fa fa-sign-in" style="color: #5C4033; font-size: 0.5em;"></i></a>
                      <?php } ?>
                    </div>   
                </div>
                <div class="prod">
                      <?php
                          $qu = " select * from products where cart='$cid' and sold=1";
